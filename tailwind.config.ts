    ...
    extend: {
      ...
      keyframes: {
        ...
        panda_run_bob: {
          ...
          "25%": { transform: "translateY(-3px) scaleY(1.04)" },
      ...
      animation: {
        ...
        "panda-gallop": "panda_gallop 0.48s ease-in-out infinite",
        "panda-run-bob": "panda_run_bob 0.48s ease-in-out infinite",
        "panda-head-bob": "panda_head_bob 0.48s ease-in-out infinite",
        "panda-reach": "panda_reach 1.26s ease-in-out infinite",
        "panda-reach-sm": "panda_reach_sm 1.26s ease-in-out infinite",
        "panda-reach-dn": "panda_reach_dn 1.26s ease-in-out infinite",
        "panda-reach-dn-sm": "panda_reach_dn_sm 1.26s ease-in-out infinite",
        "panda-hug": "panda_hug 1.26s ease-in-out infinite",
        "panda-idle": "panda_idle 4.2s ease-in-out infinite",
        "panda-wiggle": "panda_wiggle 0.48s ease-in-out infinite",
      },
    },
  },
